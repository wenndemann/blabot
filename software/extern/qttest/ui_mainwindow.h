...
**
** Created: Fri Mar 8 00:06:22 2013
...
public:
    ...
    QCheckBox *checkBoxGyroX;
    QCheckBox *checkBoxGyroY;
    QCheckBox *checkBoxGyroZ;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(120, 50, 278, 104));
        ...
        horizontalLayout_3 = new QHBoxLayout(groupBoxGyro);
        ...
        checkBoxGyroX = new QCheckBox(groupBoxGyro);
        checkBoxGyroX->setObjectName(QString::fromUtf8("checkBoxGyroX"));

        gridLayout_4->addWidget(checkBoxGyroX, 0, 0, 1, 1);

        checkBoxGyroY = new QCheckBox(groupBoxGyro);
        checkBoxGyroY->setObjectName(QString::fromUtf8("checkBoxGyroY"));

        gridLayout_4->addWidget(checkBoxGyroY, 1, 0, 1, 1);

        checkBoxGyroZ = new QCheckBox(groupBoxGyro);
        checkBoxGyroZ->setObjectName(QString::fromUtf8("checkBoxGyroZ"));

        gridLayout_4->addWidget(checkBoxGyroZ, 2, 0, 1, 1);
...
"right", 0, QApplication::UnicodeUTF8));
        ...
        checkBoxGyroX->setText(QApplication::translate("MainWindow", "X", 0, QApplication::UnicodeUTF8));
        checkBoxGyroY->setText(QApplication::translate("MainWindow", "Y", 0, QApplication::UnicodeUTF8));
        checkBoxGyroZ->setText(QApplication::translate("MainWindow", "Z", 0, QApplication::UnicodeUTF8));
