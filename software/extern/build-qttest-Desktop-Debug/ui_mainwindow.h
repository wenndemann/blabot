...
**
** Created: Sat Mar 9 16:35:24 2013
...
public:
    ...
    widgetCurveControl *widget;
    widgetCurveControl *widget_3;
    widgetCurveControl *widget_2;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        widget = new widgetCurveControl(groupBoxGyro);
        widget->setObjectName(QString::fromUtf8("widget"));

        verticalLayout->addWidget(widget);

        widget_3 = new widgetCurveControl(groupBoxGyro);
        widget_3->setObjectName(QString::fromUtf8("widget_3"));

        verticalLayout->addWidget(widget_3);

        widget_2 = new widgetCurveControl(groupBoxGyro);
